...
public class TempStatsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View myInflatedView = inflater.inflate(R.layout.fragment_temp_stats, container, false);
        user = username;
        
        AppCompatButton heartStatsButton, o2StatsButton, tempStatsButton, glucoseStatsButton, weeklyButton, monthlyButton;

        lastRecorded = (TextView) myInflatedView.findViewById(R.id.lastTemp);
        minRecorded = (TextView) myInflatedView.findViewById(R.id.minTemp);
        avgRecorded = (TextView) myInflatedView.findViewById(R.id.avgTemp);
        maxRecorded = (TextView) myInflatedView.findViewById(R.id.maxTemp);
        ...
        lineChart = (LineChart) myInflatedView.findViewById(R.id.tempPlot);
        ...
        databaseReference.child("Users").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.hasChild(user))
                {
                    ...
                    {
                        lastRecorded.setText(lastTempVal);
                    }
                }
            }
                            ...
                            if (datasnapshot.hasChildren()) {
                                ...
                                databaseReference.child("Monitored Data").child(user).child(formattedSevenDate).child(timestamp).addListenerForSingleValueEvent(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot datasnap) {
                                        if (datasnap.hasChild("Temperature"))
                                        {
                                            Log.d(TAG, "I COME TO DAY7 FOR SURE");
                                            readDay7 = datasnap.child("Temperature").getValue(Double.class);
                                ...
                                databaseReference.child("Monitored Data").child(user).child(formattedSixDate).child(timestamp).addListenerForSingleValueEvent(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot datasnap) {
                                        if (datasnap.hasChild("Temperature"))
                                        {
                                            ...
                                            readDay6 = datasnap.child("Temperature").getValue(Double.class);
                                ...
                                databaseReference.child("Monitored Data").child(user).child(formattedFiveDate).child(timestamp).addListenerForSingleValueEvent(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot datasnap) {
                                        if (datasnap.hasChild("Temperature"))
                                        {
                                            ...
                                            readDay5 = datasnap.child("Temperature").getValue(Double.class);
                                ...
                                databaseReference.child("Monitored Data").child(user).child(formattedFourDate).child(timestamp).addListenerForSingleValueEvent(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot datasnap) {
                                        if (datasnap.hasChild("Temperature"))
                                        {
                                            ...
                                            readDay4 = datasnap.child("Temperature").getValue(Double.class);
                                ...
                                databaseReference.child("Monitored Data").child(user).child(formattedThreeDate).child(timestamp).addListenerForSingleValueEvent(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot datasnap) {
                                        if (datasnap.hasChild("Temperature"))
                                        {
                                            ...
                                            readDay3 = datasnap.child("Temperature").getValue(Double.class);
                                ...
                                databaseReference.child("Monitored Data").child(user).child(formattedTwoDate).child(timestamp).addListenerForSingleValueEvent(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot datasnap) {
                                        if (datasnap.hasChild("Temperature"))
                                        {
                                            ...
                                            readDay2 = datasnap.child("Temperature").getValue(Double.class);
                                ...
                                databaseReference.child("Monitored Data").child(user).child(formattedDate).child(timestamp).addListenerForSingleValueEvent(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot datasnap) {
                                        if (datasnap.hasChild("Temperature"))
                                        {
                                            ...
                                            readDay1 = datasnap.child("Temperature").getValue(Double.class);
                            ...
                            if (datasnapshot.hasChildren()) {
                                ...
                                databaseReference.child("Monitored Data").child(user).child(formattedSevenDate).child(timestamp).addListenerForSingleValueEvent(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot datasnap) {
                                        ...
                                        {
                                            Log.d(TAG, "I COME TO DAY7 FOR SURE");
                                            final Double day7 = datasnap.child("Temperature").getValue(Double.class);
                                            avgTotal += day7;
                                            min = day7;
                                            max = day7;
                            ...
                            if (datasnapshot.hasChildren()) {
                                ...
                                databaseReference.child("Monitored Data").child(user).child(formattedSixDate).child(timestamp).addListenerForSingleValueEvent(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot datasnap) {
                                        if (datasnap.hasChild("Temperature"))
                                        {
                                            final Double day6 = datasnap.child("Temperature").getValue(Double.class);
                                            avgTotal += day6;
                                            if (day6 < min)
                                            {
                                                min = day6;
                            ...
                            if (datasnapshot.hasChildren()) {
                                ...
                                databaseReference.child("Monitored Data").child(user).child(formattedFiveDate).child(timestamp).addListenerForSingleValueEvent(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot datasnap) {
                                        if (datasnap.hasChild("Temperature"))
                                        {
                                            final Double day5 = datasnap.child("Temperature").getValue(Double.class);
                                            avgTotal += day5;
                                            if (day5 < min)
                                            {
                                                min = day5;
                            ...
                            if (datasnapshot.hasChildren()) {
                                ...
                                databaseReference.child("Monitored Data").child(user).child(formattedFourDate).child(timestamp).addListenerForSingleValueEvent(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot datasnap) {
                                        if (datasnap.hasChild("Temperature"))
                                        {
                                            final Double day4 = datasnap.child("Temperature").getValue(Double.class);
                                            avgTotal += day4;
                                            if (day4 < min)
                                            {
                                                min = day4;
                            ...
                            if (datasnapshot.hasChildren()) {
                                ...
                                databaseReference.child("Monitored Data").child(user).child(formattedThreeDate).child(timestamp).addListenerForSingleValueEvent(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot datasnap) {
                                        if (datasnap.hasChild("Temperature"))
                                        {
                                            final Double day3 = datasnap.child("Temperature").getValue(Double.class);
                                            avgTotal += day3;
                                            if (day3 < min)
                                            {
                                                min = day3;
                            ...
                            if (datasnapshot.hasChildren()) {
                                ...
                                databaseReference.child("Monitored Data").child(user).child(formattedTwoDate).child(timestamp).addListenerForSingleValueEvent(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot datasnap) {
                                        if (datasnap.hasChild("Temperature"))
                                        {
                                            final Double day2 = datasnap.child("Temperature").getValue(Double.class);
                                            avgTotal += day2;
                                            if (day2 < min)
                                            {
                                                min = day2;
                            ...
                            if (datasnapshot.hasChildren()) {
                                ...
                                databaseReference.child("Monitored Data").child(user).child(formattedDate).child(timestamp).addListenerForSingleValueEvent(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot datasnap) {
                                        if (datasnap.hasChild("Temperature"))
                                        {
                                            final Double day = datasnap.child("Temperature").getValue(Double.class);
                                            avgTotal += day;
                                            if (day < min)
                                            {
                                                min = day;
