                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            if (snapshot.hasChild(loginId))
                            {
                                ...
                                if (getPassword.equals(loginPassword))
                                {
                                    ...
                                    intent.putExtra("last_heart", getLastHeart);
                                    intent.putExtra("last_o2", getLastO2);
                                    intent.putExtra("last_temp", getLastTemp);
                                    intent.putExtra("last_glucose", getLastGlucose);
                                    intent.putExtra("last_diagnosis", getLastDiagnosis);
                                    intent.putExtra("last_recommendation", getLastRecommendation);
