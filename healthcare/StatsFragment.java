...
public class StatsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View myInflatedView = inflater.inflate(R.layout.fragment_stats, container, false);
        user = username;

        AppCompatButton heartStatsButton, o2StatsButton, tempStatsButton, glucoseStatsButton, weeklyButton, monthlyButton;

        lastRecorded = (TextView) myInflatedView.findViewById(R.id.lastHeart);
        minRecorded = (TextView) myInflatedView.findViewById(R.id.minHeart);
        avgRecorded = (TextView) myInflatedView.findViewById(R.id.avgHeart);
        maxRecorded = (TextView) myInflatedView.findViewById(R.id.maxHeart);
        ...
        lineChart = (LineChart) myInflatedView.findViewById(R.id.heartRatePlot);
        ...
        databaseReference.child("Users").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.hasChild(user))
                {
                    ...
                    {
                        lastRecorded.setText(lastHeartVal);
                    }
                }
            }
                                ...
                                databaseReference.child("Monitored Data").child(user).child(formattedSevenDate).child(timestamp).addListenerForSingleValueEvent(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot datasnap) {
                                        if (datasnap.hasChild("Heart Rate"))
                                        {
                                            ...
                                            readDay7 = datasnap.child("Heart Rate").getValue(Integer.class);
                                ...
                                databaseReference.child("Monitored Data").child(user).child(formattedSixDate).child(timestamp).addListenerForSingleValueEvent(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot datasnap) {
                                        if (datasnap.hasChild("Heart Rate"))
                                        {
                                            ...
                                            readDay6 = datasnap.child("Heart Rate").getValue(Integer.class);
                                ...
                                databaseReference.child("Monitored Data").child(user).child(formattedThreeDate).child(timestamp).addListenerForSingleValueEvent(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot datasnap) {
                                        if (datasnap.hasChild("Heart Rate"))
                                        {
                                            ...
                                            readDay3 = datasnap.child("Heart Rate").getValue(Integer.class);
                                ...
                                databaseReference.child("Monitored Data").child(user).child(formattedTwoDate).child(timestamp).addListenerForSingleValueEvent(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot datasnap) {
                                        if (datasnap.hasChild("Heart Rate"))
                                        {
                                            ...
                                            readDay2 = datasnap.child("Heart Rate").getValue(Integer.class);
                                ...
                                databaseReference.child("Monitored Data").child(user).child(formattedDate).child(timestamp).addListenerForSingleValueEvent(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot datasnap) {
                                        if (datasnap.hasChild("Heart Rate"))
                                        {
                                            ...
                                            readDay1 = datasnap.child("Heart Rate").getValue(Integer.class);
                            ...
                            if (datasnapshot.hasChildren()) {
                                ...
                                databaseReference.child("Monitored Data").child(user).child(formattedSevenDate).child(timestamp).addListenerForSingleValueEvent(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot datasnap) {
                                        ...
                                        {
                                            Log.d(TAG, "I COME TO DAY7 FOR SURE");
                                            final Integer day7 = datasnap.child("Heart Rate").getValue(Integer.class);
                                            avgTotal += day7;
                                            min = day7;
                                            max = day7;
                            ...
                            if (datasnapshot.hasChildren()) {
                                ...
                                databaseReference.child("Monitored Data").child(user).child(formattedSixDate).child(timestamp).addListenerForSingleValueEvent(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot datasnap) {
                                        if (datasnap.hasChild("Heart Rate"))
                                        {
                                            final Integer day6 = datasnap.child("Heart Rate").getValue(Integer.class);
                                            avgTotal += day6;
                                            if (day6 < min)
                                            {
                                                min = day6;
                            ...
                            if (datasnapshot.hasChildren()) {
                                ...
                                databaseReference.child("Monitored Data").child(user).child(formattedFiveDate).child(timestamp).addListenerForSingleValueEvent(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot datasnap) {
                                        if (datasnap.hasChild("Heart Rate"))
                                        {
                                            final Integer day5 = datasnap.child("Heart Rate").getValue(Integer.class);
                                            avgTotal += day5;
                                            if (day5 < min)
                                            {
                                                min = day5;
                            ...
                            if (datasnapshot.hasChildren()) {
                                ...
                                databaseReference.child("Monitored Data").child(user).child(formattedFourDate).child(timestamp).addListenerForSingleValueEvent(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot datasnap) {
                                        if (datasnap.hasChild("Heart Rate"))
                                        {
                                            final Integer day4 = datasnap.child("Heart Rate").getValue(Integer.class);
                                            avgTotal += day4;
                                            if (day4 < min)
                                            {
                                                min = day4;
                            ...
                            if (datasnapshot.hasChildren()) {
                                ...
                                databaseReference.child("Monitored Data").child(user).child(formattedThreeDate).child(timestamp).addListenerForSingleValueEvent(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot datasnap) {
                                        if (datasnap.hasChild("Heart Rate"))
                                        {
                                            final Integer day3 = datasnap.child("Heart Rate").getValue(Integer.class);
                                            avgTotal += day3;
                                            if (day3 < min)
                                            {
                                                min = day3;
                            ...
                            if (datasnapshot.hasChildren()) {
                                ...
                                databaseReference.child("Monitored Data").child(user).child(formattedTwoDate).child(timestamp).addListenerForSingleValueEvent(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot datasnap) {
                                        if (datasnap.hasChild("Heart Rate"))
                                        {
                                            final Integer day2 = datasnap.child("Heart Rate").getValue(Integer.class);
                                            avgTotal += day2;
                                            if (day2 < min)
                                            {
                                                min = day2;
                            ...
                            if (datasnapshot.hasChildren()) {
                                ...
                                databaseReference.child("Monitored Data").child(user).child(formattedDate).child(timestamp).addListenerForSingleValueEvent(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot datasnap) {
                                        if (datasnap.hasChild("Heart Rate"))
                                        {
                                            final Integer day = datasnap.child("Heart Rate").getValue(Integer.class);
                                            avgTotal += day;
                                            if (day < min)
                                            {
                                                min = day;
